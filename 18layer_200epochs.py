...
parser.add_argument("--bn_indnorm", type=str, default="local", choices=["none","global","local"])
parser.add_argument("--bn_tnorm", type=str, default="local", choices=["none","global","local","location","image"])
...
if dof == math.inf:
    model = nn.Sequential(ZCAWhiten(X_full),
                          ...
                          dkm.ConvF2G(),
                          dkm.ReluKernel(),
                          dkm.ConvMixup(n_ind, 16 * n_ind_scale, filter_size=3, stride=1),
                          #dkm.GramLayer(16 * n_ind_scale, args.dof),
                          dkm.GramBatchNorm(args.bn_indnorm, args.bn_tnorm, args.bn_indscale, args.bn_tscale),
                          dkm.noGram_ResNetBlock(3, 16 * n_ind_scale, 16 * n_ind_scale, args.dof, 3, 2, args.bn_indnorm, args.bn_tnorm, args.bn_indscale, args.bn_tscale),
                          dkm.noGram_ResNetBlock(3, 16 * n_ind_scale, 32 * n_ind_scale, args.dof, 3, 2, args.bn_indnorm, args.bn_tnorm, args.bn_indscale, args.bn_tscale),
                          dkm.noGram_ResNetBlock(3, 32 * n_ind_scale, 64 * n_ind_scale, args.dof, 3, 2, args.bn_indnorm, args.bn_tnorm, args.bn_indscale, args.bn_tscale),
                          ...
                          dkm.Output(64 * n_ind_scale, no_classes, **sum_kwargs),
                          )
else:
    model = nn.Sequential(ZCAWhiten(X_full),
                          dkm.Input(x_ind, learned=ind_learned),
                          ...
                          dkm.GramLayer(16 * n_ind_scale, args.dof),
                          dkm.GramBatchNorm(args.bn_indnorm, args.bn_tnorm, args.bn_indscale, args.bn_tscale),
                          dkm.ResNetBlock(3, 16 * n_ind_scale, 16 * n_ind_scale, args.dof, 3, 2, args.bn_indnorm, args.bn_tnorm, args.bn_indscale, args.bn_tscale),
                          dkm.ResNetBlock(3, 16 * n_ind_scale, 32 * n_ind_scale, args.dof, 3, 2, args.bn_indnorm, args.bn_tnorm, args.bn_indscale, args.bn_tscale),
                          dkm.ResNetBlock(3, 32 * n_ind_scale, 64 * n_ind_scale, args.dof, 3, 2, args.bn_indnorm, args.bn_tnorm, args.bn_indscale, args.bn_tscale),
                          Final_layer(*final_layer_args),
                          dkm.GramBatchNorm(args.bn_indnorm, bn_spatial_nonspatial_equiv[args.bn_tnorm], args.bn_indscale, bn_spatial_nonspatial_equiv[args.bn_tscale]),
                          dkm.Output(64 * n_ind_scale, no_classes, **sum_kwargs),
                          )
...
milestones = [80, 160]  # Epochs where learning rate will change
